<template>
    <li class="timeline-item" :class="!item ? `timeline-item-trailing` : ``">
        <IconView
...
li.timeline-item-trailing {
    ...
    div.timeline-item-icon {
        @each $breakpoint,
            $size
                in (
                    xxxl: $article-timeline-image-size,
                    md: $article-timeline-image-size-md,
                    sm: $article-timeline-image-size-sm
                )
        {
